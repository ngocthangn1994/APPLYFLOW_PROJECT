...
export default function Page() {
  return (
    <AppShell title="Team Chat" links={links}>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600">
                Chat with your assigned assistant in real time, share documents,
                receive workflow updates, and respond quickly when applications
