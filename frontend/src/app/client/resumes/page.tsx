...
const onboardingAnswers = [
  ...
  { label: "Sponsorship needed", value: "No" },
  { label: "Open locations", value: "Austin, Houston, Dallas, Remote" },
  { label: "Relocation", value: "Yes, for a strong opportunity" },
...
export default function Page() {
  return (
    <AppShell title="Resumes & More" links={links}>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600">
                Manage resume versions, review AI insights, and update your
                application answers so matches and assistant workflows stay
                accurate.
              </p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          <div className="space-y-6 xl:col-span-2">
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Upload multiple versions and set one as your default resume.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Edit your onboarding answers anytime so assistants can apply
                accurately.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Insights generated from your resume to improve fit and
                application quality.
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">
                Your primary resume is currently used for job matching,
                assistant review, and generated document workflows across the
                dashboard.
              </div>
            </div>
          </div>
