        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-600">
              Manage your plan, review invoices, and keep your assistant support
              package active without interruption.
            </p>
          </div>
                  ...
                  {invoices.map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50/70">
                      ...
                      <td className="px-4 py-4">
                        <span
                          className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${getInvoiceStatusClasses(item.status)}`}
                        >
                          {item.status}
                        </span>
                      </td>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">
              ...
              application proof tracking. Changes take effect on the next
              billing cycle unless noted otherwise.
            </div>
          </div>
        </div>
      </div>
