const summaryStats = [
  { label: "Active clients", value: "312", subtext: "+18 this month" },
  { label: "Assigned assistants", value: "14", subtext: "2 near capacity" },
  {
    label: "Applications completed",
    value: "1,284",
    subtext: "+12% this week",
  },
  { label: "Evidence verified", value: "198", subtext: "80% approved" },
];
