              ...
              <tbody className="divide-y divide-slate-100">
                {clients.map((client) => (
                  <tr key={client.email} className="hover:bg-slate-50/70">
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${getOnboardingClasses(client.onboarding)}`}
                      >
                        {client.onboarding}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${getStatusClasses(client.status)}`}
                      >
                        {client.status}
                      </span>
                    </td>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="rounded-2xl bg-slate-50 p-4">
                ...
                <div className="mt-3 h-2 rounded-full bg-slate-200">
                  <div className="h-2 w-[10%] rounded-full bg-rose-500" />
                </div>
              </div>
            </div>
          </div>
