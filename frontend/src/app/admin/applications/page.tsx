...
const queueCards = [
  {
    ...
    value: "18",
    description: "Applications waiting on client or assistant response.",
  },
  {
    title: "Proof pending",
    value: "9",
    description: "Submission evidence still missing from the workflow.",
  },
  {
    title: "Escalations",
    value: "4",
    description: "High-priority items that need admin review today.",
  },
];
...
export default function Page() {
  return (
    <AppShell title="Admin applications" links={links}>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600">
                ...
                the assistant workflow moving with clean visibility across
                clients.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 border-b border-slate-200 p-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                A quick view of the latest application activity across clients
                and assistants.
              </p>
            </div>
